...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Ganesh Kaithoju — Full Stack Developer, Software Engineer, and CS student building scalable, elegant web applications." },
      ...
      { property: "og:title", content: "Ganesh Kaithoju — Full Stack Developer" },
      { property: "og:description", content: "Award-worthy portfolio of Ganesh Kaithoju — Full Stack Developer & Software Engineer." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Ganesh Kaithoju" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Ganesh Kaithoju — Full Stack Developer" },
      { name: "twitter:description", content: "Award-worthy portfolio of Ganesh Kaithoju." },
